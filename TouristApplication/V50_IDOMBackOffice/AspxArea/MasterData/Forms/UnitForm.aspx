                ...
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td style="width: 115px">Site code:</td>
                                <td>
                                    <dx:ASPxLabel ID="lblSiteCode" runat="server">
                                    </dx:ASPxLabel>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 115px">Unit code:</td>
                                <td>
                                    <dx:ASPxLabel ID="lblUnitCode" runat="server">
                                    </dx:ASPxLabel>
                                </td>
                            </tr>
                        </table>
                ...
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        ...
                        <table class="dxflInternalEditorTable">
                            <tr>
                                <td style="width: 77px">
                                    <dx:ASPxButton ID="btnCopy" runat="server" Text="Copy" AutoPostBack="false" OnClick="btnCopy_Click">
                    ...
                    <dx:ContentControl runat="server">
                        <dx:ASPxGridView ID="GridUnitOfferView" runat="server" AutoGenerateColumns="False" KeyFieldName="id" OnCellEditorInitialize="GridUnitOfferView_CellEditorInitialize" OnCustomButtonCallback="GridUnitOfferView_CustomButtonCallback" OnDataBinding="GridUnitOfferView_DataBinding" OnInit="GridUnitOfferView_Init" OnRowDeleting="GridUnitOfferView_RowDeleting" OnRowInserting="GridUnitOfferView_RowInserting" OnRowUpdating="GridUnitOfferView_RowUpdating" OnRowValidating="GridUnitOfferView_RowValidating" OnStartRowEditing="GridUnitOfferView_StartRowEditing">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="OfferCode" ShowInCustomizationForm="True" VisibleIndex="6">
                                    <PropertiesTextEdit Width="100px">
                                    </PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="OfferTitel" ShowInCustomizationForm="True" VisibleIndex="7">
                                    <PropertiesTextEdit Width="100px">
                                    </PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="OfferDescription" Name="OfferDescription" ShowInCustomizationForm="True" VisibleIndex="8">
                                    <EditFormSettings Visible="True" />
                                    <EditItemTemplate>
                                        <dx:ASPxHtmlEditor ID="ASPxHtmlEditorDescription" Height="300" runat="server" Html='<%# Bind("OfferDescription") %>'>
                                        </dx:ASPxHtmlEditor>
                                    </EditItemTemplate>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="OfferCount" ShowInCustomizationForm="True" VisibleIndex="9">
                                    <PropertiesTextEdit Width="100px">
                                    </PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataCheckColumn FieldName="IsAutoStopBooking" ShowInCustomizationForm="True" VisibleIndex="10">
                                ...
                                <dx:GridViewDataTextColumn FieldName="UnitCode" ShowInCustomizationForm="True" VisibleIndex="5">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataMemoColumn FieldName="ProviderNotice" Name="ProviderNotice" ShowInCustomizationForm="True" VisibleIndex="11">
