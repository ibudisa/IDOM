...
<dx:ASPxFormLayout ID="LayoutProvider" runat="server" Width="548px" ColCount="2">
    ...
    <br />
    <br />
    <dx:ASPxPageControl ID="PageControlProvider" runat="server" ActiveTabIndex="3">
        <TabPages>
            ...
            <dx:TabPage Text="Cancellations">
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        <dx:ASPxGridView ID="GridCancellationView" runat="server" AutoGenerateColumns="False" KeyFieldName="Id" OnInit="GridCancellationView_Init" OnRowDeleting="GridCancellationView_RowDeleting" OnRowInserting="GridCancellationView_RowInserting" OnRowUpdating="GridCancellationView_RowUpdating" OnRowValidating="GridCancellationView_RowValidating" OnStartRowEditing="GridCancellationView_StartRowEditing">
                            <EditFormLayoutProperties ColCount="2">
                                <Items>
                                    <dx:GridViewColumnLayoutItem ColumnName="FromDay">
                                    </dx:GridViewColumnLayoutItem>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataDateColumn FieldName="FromDay" ShowInCustomizationForm="True" VisibleIndex="2">
                                </dx:GridViewDataDateColumn>
                                <dx:GridViewDataDateColumn FieldName="ToDay" ShowInCustomizationForm="True" VisibleIndex="3">
                                </dx:GridViewDataDateColumn>
                                <dx:GridViewDataTextColumn FieldName="Percent" ShowInCustomizationForm="True" VisibleIndex="4">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>
                    </dx:ContentControl>
