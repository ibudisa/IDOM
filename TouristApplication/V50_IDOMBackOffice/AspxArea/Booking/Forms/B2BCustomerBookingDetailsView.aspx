<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="B2BCustomerBookingDetailsView.aspx.cs" Inherits="V50_IDOMBackOffice.AspxArea.Booking.Forms.B2BCustomerBookingDetailsView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        <br />
<dx:ASPxFormLayout ID="LayoutB2BCustomer" runat="server" Width="548px" ColCount="2">
    <Items>
    ...
    <dx:ASPxPageControl ID="PageControlB2BCustomer" runat="server" ActiveTabIndex="2">
        <TabPages>
            <dx:TabPage Text="BookingProcesses">
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        <dx:ASPxGridView ID="GridBookingProcessView" runat="server" AutoGenerateColumns="False" KeyFieldName="Id" OnCustomButtonCallback="GridBookingProcessView_CustomButtonCallback" OnInit="GridBookingProcessView_Init">
