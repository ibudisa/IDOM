...
<body>
    ...
    <div>
        ...
        <table class="dx-justification">
            <tr>
                <td class="auto-style3">UnitCode:</td>
                <td class="auto-style4">
                    <dx:ASPxComboBox ID="comboboxUnitCode" runat="server" ValueType="System.String" TextField="Name" ValueField="Id" AutoPostBack="True" OnSelectedIndexChanged="comboboxUnitCode_SelectedIndexChanged">
                    </dx:ASPxComboBox>
                </td>
            </tr>
        </table>
